...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
 <%
 String num = request.getParameter("num");	//일련 번호 받기
...
<body>
	...
	<form name="wirteFrm" action="EditProcess.jsp" method="post" onsubmit="return validateForm(this);">
		<input type="hidden" name="num" value="<%= dto.getNum() %>" />
		<!-- 수정하지 않아야 하는 정보이기 때문에 hidden을 사용한다. -->
